...
public:
    Loom(vector<Block::Ptr> blocks, Statistics& statistics, size_t num_threads, size_t table_partitions = 1, bool enable_inter_block = true, bool enable_nested_reExecution = true);
    void Start() override;
    void Stop() override;
