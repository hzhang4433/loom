...
# savepath = f'../pics/warehouse/bench_warehouse_{block_size}:{thread_num}_tps.pdf'
savepath = f'./bench_warehouse_{block_size}:{thread_num}_tps.pdf'
...
#     step = 13000
p.format_yticks(ax, suffix='K', step=10000, step_num=4) # 5000 7500 10000
